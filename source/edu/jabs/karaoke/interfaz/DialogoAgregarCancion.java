...
/**
 * Diálogo que permite agregar una nueva canción al karaoke.
 */
public class DialogoAgregarCancion extends JDialog implements ActionListener
{
    ...
    /**
     * Campo de texto con la categoría de la canción.
     */
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( comando.equals( AGREGAR ) )
        {
            ...
            if( nombre != null && !nombre.isEmpty( ) && dificultadS != null && !dificultadS.isEmpty( ) && duracionS != null && !duracionS.isEmpty( ) && ruta != null && !ruta.isEmpty( ) && letra != null && !letra.isEmpty( ) && artista != null )
            {
                ...
                {
                    JOptionPane.showMessageDialog( this, "La duración y la dificultad de la canción deben ser valores numéricos.", "Agregar canción", JOptionPane.ERROR_MESSAGE );
                }
            }
            else
            {
