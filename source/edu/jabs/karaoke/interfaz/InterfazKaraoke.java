...
public class InterfazKaraoke extends JFrame
{
    ...
    /**
     * Retorna los artistas de una categoría.
     * @param pCategoria Categoría de los artistas. pCategoria != null y pCategoria != "".
    ...
    /**
     * Retorna la categoría seleccionada en el panel de artista.
    ...
    /**
     * Retorna la lista de canciones del karaoke dada una categoría.
     * @param pCategoria Categoría de las canciones. pCategoría != null && pCategoría != "".
     * @return Lista de canciones de la categoría dada.
     */
     ...
     * <b>pre:</b> La lista de listas de reproducción está inicializada.<br>
     ...
     * @param pCategoria Categoría seleccionada del karaoke. pCategoria != null.
     */
    ...
    /**
     * Muestra el diálogo para modificar canciones de la lista de reproducción seleccionada.
     */
    ...
    public void mostrarCancionMasDificil( )
    {
        ...
        if( cancion != null )
        {
            JOptionPane.showMessageDialog( this, "La canción más difícil es " + cancion.darNombre( ), "Más difícil", JOptionPane.INFORMATION_MESSAGE );
        }
        else
        {
    ...
    public void mostrarCancionMasFacil( )
    {
        ...
        if( cancion != null )
        {
            JOptionPane.showMessageDialog( this, "La canción más fácil es " + cancion.darNombre( ), "Más fácil", JOptionPane.INFORMATION_MESSAGE );
        }
        else
        {
            JOptionPane.showMessageDialog( this, "No existen canciones en el karaoke.", "Error", JOptionPane.ERROR_MESSAGE );
    ...
    public void mostrarCancionMasLarga( )
    {
        ...
        if( cancion != null )
        {
            JOptionPane.showMessageDialog( this, "La canción más larga es " + cancion.darNombre( ), "Más larga", JOptionPane.INFORMATION_MESSAGE );
        }
        else
        {
            JOptionPane.showMessageDialog( this, "No existen canciones en el karaoke.", "Error", JOptionPane.ERROR_MESSAGE );
    ...
    public void mostrarCancionMasCorta( )
    {
        ...
        if( cancion != null )
        {
            JOptionPane.showMessageDialog( this, "La canción más corta es " + cancion.darNombre( ), "Más corta", JOptionPane.INFORMATION_MESSAGE );
        }
        else
        {
            JOptionPane.showMessageDialog( this, "No existen canciones en el karaoke.", "Error", JOptionPane.ERROR_MESSAGE );
    ...
    /**
     * Muestra el diálogo que permite agregar una lista de reproducción.
     */
    ...
    /**
     * Muestra el diálogo para agregar o eliminar canciones de una lista de reproducción.
