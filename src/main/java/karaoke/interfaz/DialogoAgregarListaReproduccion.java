...
/**
 * Diólogo para agregar una lista de reproducción.
 *
 */
public class DialogoAgregarListaReproduccion extends JDialog implements ActionListener
{
    ...
    /**
     * Crea el diólogo para agregar una lista de reproducción.
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( comando.equals( ACEPTAR ) )
        {
            ...
            if( nombre.equals( "" ) )
            {
                JOptionPane.showMessageDialog( this, "El nombre no puede estar vacóo.", "Agregar lista de reproducción", JOptionPane.ERROR_MESSAGE );
            }
            else
            {
