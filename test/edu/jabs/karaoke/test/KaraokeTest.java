...
/**
 * Clase usada para verificar que los métodos de la clase Karaoke estén correctamente implementados.
 */
public class KaraokeTest extends TestCase
{
    ...
    private void setUpEscenario2( )
    {
        ...
        karaoke.agregarCancion( "Bomba Estéreo", "cancion13", 345, "letra13", 3, "ruta13" );
    ...
    public void testKaraoke( )
    {
        ...
        assertEquals( "Artista 7 incorrecto.", "Bomba Estéreo", artistas[ 6 ].darNombre( ) );
    ...
    /**
     * Prueba 2: Se encarga de verificar el método buscarArtista.<br>
     * <b> Métodos a probar: </b> <br>
     * buscarArtista <br>
     * darNombre <br>
     * <b> Casos de prueba:</b><br>
    ...
    public void testBuscarArtista( )
    {
        ...
        assertNull( "El artista debería ser nulo.", artista2 );
    }
    ...
    public void testAgregarCancion( )
    {
        ...
        assertTrue( "Se debería agregar la canción al karaoke.", agregada );
        ...
        assertFalse( "No se debería agregar la canción al karaoke.", agregada2 );
        assertEquals( "El  número de canciones del artista no debería cambiar.", 1, a.darCanciones( ).size( ) );
    }

    /**
     * Prueba 4: Se encarga de verificar el método darCancionMasDificil.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionMasDificil <br>
     * darNombre <br>
     * darDificultad <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentra la canción más difícil.
     */
    public void testDarCancionMasDificil( )
    {
        ...
        assertEquals( "La canción retornada no es la más difícil.", "cancion12", dificil.darNombre( ) );
        assertEquals( "La canción retornada no es la más difícil.", 9, dificil.darDificultad( ) );
    }

    /**
     * Prueba 5: Se encarga de verificar el método darCancionMasFacil.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionMasFacil <br>
     * darNombre <br>
     * darDificultad <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentra la canción más fácil.
     */
    public void testDarCancionMasFacil( )
    {
        ...
        assertEquals( "La canción retornada no es la más fácil.", "cancion9", facil.darNombre( ) );
        assertEquals( "La canción retornada no es la más fácil.", 1, facil.darDificultad( ) );

    }

    /**
     * Prueba 6: Se encarga de verificar el método darCancionMasLarga.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionMasLarga <br>
     * darNombre <br>
     * darDuracion <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentra la canción más larga.
     */
    public void testDarCancionMasLarga( )
    {
        ...
        assertEquals( "La canción retornada no es la más larga.", "cancion3", larga.darNombre( ) );
        assertEquals( "La canción retornada no es la más larga.", 450, larga.darDuracion( ) );
    }

    /**
     * Prueba 7: Se encarga de verificar el método darCancionMasCorta.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionMasCorta <br>
     * darNombre <br>
     * darDuracion <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentra la canción más corta.
     */
    ...
    /**
     * Prueba 8: Se encarga de verificar el método darArtistaMasCanciones.<br>
     * <b> Métodos a probar: </b> <br>
     * darArtistaMasCanciones <br>
     * darNombre <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentra el artista con más canciones.
     */
    public void testDarArtistaMasCanciones( )
    {
        ...
        assertNotNull( "El artista no debería ser nulo", artista );
        assertEquals( "El artista retornado no es el artista con mayor número de canciones.", "AC/DC", artista.darNombre( ) );
    }

    /**
     * Prueba 9: Se encarga de verificar el método darCancionesCategoria.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionesCategoria <br>
     * darNombre <br>
     * <b> Casos de prueba:</b><br>
     * 1. Se encuentran las canciones para una cateogría.
     */
    ...
    /**
     * Prueba 9: Se encarga de verificar el método buscarCancionEnKaraoke.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    public void testBuscarCancionEnKaraoke( )
    {
        ...
        // 1
        assertNotNull( "La canción no debería ser nula.", c );
        ...
        assertNull( "La canción debería ser nula.", c2 );
    }

    /**
     * Prueba 10: Se encarga de verificar el método buscarListaReproduccion.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    public void testBuscarListaReproduccion( )
    {
        ...
        assertNotNull( "La lista de reproducción no debería ser nula.", lista );
        ...
        assertEquals( "La lista de reproducción debería ser nula.", -1, lista2 );
    }

    /**
     * Prueba 11: Se encarga de verificar el método agregarListaReproduccion.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    public void testAgregarListaReproduccion( )
    {
        ...
        assertEquals( "El número de listas de reproducción del karaoke debería cambiar.", 3, karaoke.darListasDeReproduccion( ).size( ) );

    }
    /**
     * Prueba 12: Se encarga de verificar el método eliminarListaReproduccion.<br>
     * <b> Métodos a probar: </b> <br>
    ...
    public void testEliminarListaReproduccion( )
    {
        ...
        assertEquals( "El número de listas de reproducción del karaoke debería cambiar.", 1, karaoke.darListasDeReproduccion( ).size( ) );

    }

    /**
     * Prueba 13: Se encarga de verificar el método darCancionesArtista, para un karaoke con canciones.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionesArtista<br>
     * <b> Casos de prueba:</b><br>
     * 1. Un artista tiene varias canciones y corresponden. <br>
     * 2. Un artista tiene una única canción y corresponde.
     */
    ...
    /**
     * Prueba 14: Se encarga de verificar el método darCancionesArtista, para un karakoe sin canciones.<br>
     * <b> Métodos a probar: </b> <br>
     * darCancionesArtista<br>
     * <b> Casos de prueba:</b><br>
    ...
    /**
     * Prueba 15: Se encarga de verificar el método eliminarCancionDeListaReproduccion.<br>
     * <b> Métodos a probar: </b> <br>
